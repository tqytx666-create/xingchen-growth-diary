...
import f7_walk from '../assets/living/form_f7_walk.mp4'
import f7_happy from '../assets/living/form_f7_happy.mp4'
import f8_walk from '../assets/living/form_f8_walk.mp4'
import f8_happy from '../assets/living/form_f8_happy.mp4'
import f9_walk from '../assets/living/form_f9_walk.mp4'
import f9_happy from '../assets/living/form_f9_happy.mp4'
import f10_walk from '../assets/living/form_f10_walk.mp4'
import f10_happy from '../assets/living/form_f10_happy.mp4'
import f11_walk from '../assets/living/form_f11_walk.mp4'
import f11_happy from '../assets/living/form_f11_happy.mp4'
import f12_walk from '../assets/living/form_f12_walk.mp4'
import f12_happy from '../assets/living/form_f12_happy.mp4'
import f13_walk from '../assets/living/form_f13_walk.mp4'
import f13_happy from '../assets/living/form_f13_happy.mp4'
import f14_walk from '../assets/living/form_f14_walk.mp4'
import f14_happy from '../assets/living/form_f14_happy.mp4'
...
const FORM_SETS = { 1: BASE, 2: EVO2, 3: EVO3, 4: EVO4, 5: EVO5, 6: skinSet(f6_walk, f6_happy), 7: skinSet(f7_walk, f7_happy), 8: skinSet(f8_walk, f8_happy), 9: skinSet(f9_walk, f9_happy), 10: skinSet(f10_walk, f10_happy), 11: skinSet(f11_walk, f11_happy), 12: skinSet(f12_walk, f12_happy), 13: skinSet(f13_walk, f13_happy), 14: skinSet(f14_walk, f14_happy), 15: GOD }
...
// 👨‍🍳 小厨师
import sk_chef_walk from '../assets/living/skin_chef_walk.mp4'
import sk_chef_happy from '../assets/living/skin_chef_happy.mp4'
// 🏴‍☠️ 小海盗
import sk_pirate_walk from '../assets/living/skin_pirate_walk.mp4'
import sk_pirate_happy from '../assets/living/skin_pirate_happy.mp4'
// 😇 小天使
import sk_angel_walk from '../assets/living/skin_angel_walk.mp4'
import sk_angel_happy from '../assets/living/skin_angel_happy.mp4'
// 🏮 小汉服
...
// 🐰 兔子睡衣
import sk_bunny_walk from '../assets/living/skin_bunny_walk.mp4'
import sk_bunny_happy from '../assets/living/skin_bunny_happy.mp4'
// 🦄 独角兽装
import sk_unicorn_walk from '../assets/living/skin_unicorn_walk.mp4'
import sk_unicorn_happy from '../assets/living/skin_unicorn_happy.mp4'
// 🧜‍♀️ 小美人鱼
...
const SKIN_SETS = {
  ...
  bunny: skinSet(sk_bunny_walk, sk_bunny_happy),
  unicorn: skinSet(sk_unicorn_walk, sk_unicorn_happy),
